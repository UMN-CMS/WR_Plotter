...
ENV_PLOT_PATH = '/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/output'
...
#### Systematic
m.Systematics = [Systematic(Name="Central", Direction=0, Year=2018)]
...
m.VariablesToDraw = [
    ...
    Variable('Lepton_1_Pt', r'$p_{T}$ of the subleading lepton', 'GeV'),
    Variable('WRCand_Mass', r'$m_{W_{R}}$ (GeV)', 'GeV'),
]
m.PrintVariables()
