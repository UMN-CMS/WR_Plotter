...
file_path_run2 = "/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/root_files/Run2Summer20UL18/WRAnalyzer_SkimTree_LRSMHighPt_DYJets.root"
file_path_run3 = "/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/root_files/Run3Summer22/WRAnalyzer_SkimTree_LRSMHighPt_DYJets.root"
...
for folder in folders:
    for hist_prefix in histograms:
        ...
        fig, ax = plt.subplots()
        hep.histplot(values_run2, edges_run2, label="DY+Jets (Run2Summer20UL18)", histtype="step", color="blue")
        hep.histplot(values_run3, edges_run3, label="DY+Jets (Run3Summer22)", histtype="step", color="red")
...
#        plt.close()
        ...
        print(np.sum(values_run2_norm))
        print(np.sum(values_run3_norm))
        # Plot normalized histograms
        fig, ax = plt.subplots()
        hep.histplot(values_run2_norm, edges_run2, label="DY+Jets (Run2Summer20UL18)", histtype="step", color="blue")
        hep.histplot(values_run3_norm, edges_run3, label="DY+Jets (Run3Summer22)", histtype="step", color="red")
