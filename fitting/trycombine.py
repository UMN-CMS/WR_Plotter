...
mass.setRange("loSB", 1000, 1750 )#1750
mass.setRange("hiSB", 2750, 4000 )#2750
mass.setRange("full", 1000, 4000 )
fit_range = "loSB,hiSB"
# fit_range = "full"

alpha1 = ROOT.RooRealVar("alpha1", "alpha1", -0.00378, -0.2, 0 )
alpha2 = ROOT.RooRealVar("alpha2", "alpha2", -0.00378, -0.2, 0 )
a = ROOT.RooRealVar("A", "Coeff TT", 0.005, 0, 1)
a_scaled = ROOT.RooFormulaVar("A_scaled", "2*@0", ROOT.RooArgList(a))
b = ROOT.RooRealVar("B", "Coeff DY", 0.01, 0, 1)
...
for mpoint in mpoints:
    ...
    c = ROOT.RooRealVar("C", "Coeff Signal", 0.00158, 0, 1)
