...
def setup_plotter(args) -> Plotter:
    ...
    plotter.regions_to_draw = [
        Region('MuMu_DYCR',    'Muon', unblind_data = True, tlatex_alias='$\mu\mu$\nNo Jet Requirements'),
        Region('MuMu_DYCR_2J', 'Muon', unblind_data = True, tlatex_alias='$\mu\mu$\n2 Jets'),
        Region('MuMu_DYCR_3J', 'Muon', unblind_data = True, tlatex_alias='$\mu\mu$\n3 Jets'),
        Region('MuMu_DYCR_4J', 'Muon', unblind_data = True, tlatex_alias='$\mu\mu$\n4 Jets'),
        Region('MuMu_DYCR_5J', 'Muon', unblind_data = True, tlatex_alias='$\mu\mu$\n5 Jets'),
        Region('EE_DYCR',    'EGamma', unblind_data = True, tlatex_alias='ee\nNo Jet Requirements'),
        Region('EE_DYCR_2J', 'EGamma', unblind_data = True, tlatex_alias='ee\n2 Jets'),
        Region('EE_DYCR_3J', 'EGamma', unblind_data = True, tlatex_alias='ee\n3 Jets'),
        Region('EE_DYCR_4J', 'EGamma', unblind_data = True, tlatex_alias='ee\n4 Jets'),
        Region('EE_DYCR_5J', 'EGamma', unblind_data = True, tlatex_alias='ee\n5 Jets'),
    ]
