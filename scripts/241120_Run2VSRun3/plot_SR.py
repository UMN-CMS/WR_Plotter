...
def main():
    ...
    rebin_filepath = Path('/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/data/241120_Run2VSRun3/SR_rebins.txt') 
    xaxis_filepath = Path('/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/data/241120_Run2VSRun3/SR_xaxis.txt')
    yaxis_filepath = Path('/uscms/home/bjackson/nobackup/WrCoffea/WR_Plotter/data/241120_Run2VSRun3/SR_yaxis.txt')
