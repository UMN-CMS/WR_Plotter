...
def setup_plotter(args) -> Plotter:
    ...
    plotter.variables_to_draw = [
        ...
        Variable('ZCand_Pt', r'$p_{T}^{ll}$', 'GeV'),
        Variable('Dijet_Mass', r'$m_{jj}$', 'GeV'),
        Variable('Dijet_Pt', r'$p_{T}^{jj}$', 'GeV'),
        Variable('NCand_Lepton_0_Mass', r'$m_{l_{\mathrm{lead}}jj}$', 'GeV'),
        Variable('NCand_Lepton_0_Pt', r'$p^{T}_{l_{\mathrm{lead}}jj}$', 'GeV'),
        Variable('NCand_Lepton_1_Mass', r'$m_{l_{\mathrm{sublead}}jj}$', 'GeV'),
        Variable('NCand_Lepton_1_Pt', r'$p^{T}_{l_{\mathrm{sublead}}jj}$', 'GeV'),
